...
function send_message(thisTxt){
    ...
    var title = $('#cultural_event_Title').val().trim();
    var message = $('#cultural_event_message').val();
    ...
    $.ajax({
        type: 'POST',
        url: "/event-management/send-message-culturalevent",
...
function schedule_message(thisTxt){
    var receiverID = $(thisTxt).attr('receiverID');
    var title = $('#cultural_event_sched_Title').val().trim();
    var message = $('#cultural_event_sched_message').val();
    ...
    $.ajax({
        type: 'POST',
        url: "/event-management/shedule-message-culturalevent",
        headers: { 'X-CSRFToken': csrftoken },
        data: formdata,
        cache : false,
        processData : false,
...
function send_message_modal(thisTxt){
    ...
    var receiverName = $(thisTxt).attr('eventName');
    ...
    $('#eventName').html('')
    $('#eventName').append(receiverName)
    // --------------------------------------------------------
}

function schedule_message_modal(thisTxt){
    var receiverID = $(thisTxt).attr('recID');
    var receiverName = $(thisTxt).attr('eventsName');
    // var receiverImage = $(thisTxt).attr('recImage');
    ...
    $('#eventsName').html('')
    $('#eventsName').append(receiverName)
    // --------------------------------------------------------
}
// ##############################################################################################################
// ##############################################################################################################
